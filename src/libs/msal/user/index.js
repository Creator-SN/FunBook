...
var User = /** @class */ (function () {
    ...
    User.prototype.getProfile = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.api(UserEndpoint.Profile).get()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    User.prototype.getAvatarMetadata = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.api(UserEndpoint.AvatarMedadata).get()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    User.prototype.getAvatar = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.api(UserEndpoint.Avatar).get()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
